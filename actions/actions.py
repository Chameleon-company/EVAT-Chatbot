...
class ActionGetNearestStation(Action):
    ...
    async def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        with open("data\datasets\ml_ev_charging_dataset.csv", "r") as file:
                reader = csv.reader(file)

                for row in reader:
                   if row[4] == result['Address']:
...
class ActionToChargingStation(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        suburb_location_lat = 0
        suburb_location_long = 0
       ...
       #check if the location the user has specified as a charging station. 
        with open("data\datasets\Co-oridnates.csv", "r") as file:
                reader = csv.reader(file)
...
class ActionChargerInfo(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        with open("data\datasets\charger_info_mel.csv", "r") as file:
            reader = csv.reader(file)
